...
const villaLinks = [
  ...
  { label: "Location villa Marrakech avec piscine privée", href: "/villas/villa-avec-piscine-marrakech" },
  { label: "Location villa Marrakech avec piscine chauffée", href: "/villas/villa-avec-piscine-marrakech" },
